/**
 * Single typed reader/writer for the extension's config file (co-located
 * with the extension, matching pi's sibling convention:
 * ~/.pi/agent/extensions/pi-webtools-lite/config.json).
 *
...
import { GuidanceFieldsSchema, loadJsonConfig, saveJsonConfig } from "../rpiv-config.js";
...
const CONFIG_PATH = join(homedir(), ".pi", "agent", "extensions", "pi-webtools-lite", "config.json");
